...
class DockerConfig(db.Model):
    ...
    ca_cert = db.Column("ca_cert", db.String(5000), index=True)
    client_cert = db.Column("client_cert", db.String(5000), index=True)
    client_key = db.Column("client_key", db.String(5000), index=True)
